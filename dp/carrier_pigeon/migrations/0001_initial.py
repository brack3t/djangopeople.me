...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('carrier_pigeon_message', (
        ...
        db.send_create_signal('carrier_pigeon', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table('carrier_pigeon_message')
